...
<div class="page">
	...
	<p>Konečně se nám podařilo najít Tobíka! Víme, že je v obývacím pokoji. Bude to stačit?</p>

	<div class="button-help">
		<button on:click={toggleHelp}>Pomoc</button>
		<div class="help-item" class:visible={help[1]}>Opticka iluze</div>
	</div>
	<div class="form">
