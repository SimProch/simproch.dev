...
<div class="page">
	<div style="font-size: 1rem; font-weight: 600">Záhada obývacího pokoje</div>

	<p>Optická iluze odhalila další kód</p>
	<p>K5S1</p>

	<div class="button-help">
		<button on:click={toggleHelp}>Pomoc</button>
		<div class="help-item" class:visible={help[1]}>Nove knihy?</div>
		<div class="help-item" class:visible={help[2]}>K je kapitola</div>
	</div>
	<div class="form">
